...
namespace BigWoo.Apps.SqlCodeGen.Classes
{
    ...
    public class MemberNameFormatterLoader
    {
        ...
        private static IDataMemberNameFormatter LoadFormatter(string configurationInfoStr)
        {
            ...
            //
            // such as:
            // BigWoo.Apps.SqlCodeGen.Classes.DefaulMemberNameFormatter,SqlCodeGenSupport
        ...
        public static IDataMemberNameFormatter LoadFormatter(string configurationInfoStr, bool loadDefaultOnFailure)
        {
            ...
            catch
            {
                ...
                {
                    const string DEFAULT_CONFIG_INFO = "BigWoo.Apps.SqlCodeGen.Classes.DefaulMemberNameFormatter,SqlCodeGenSupport";
