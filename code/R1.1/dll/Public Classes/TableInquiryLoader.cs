...
namespace BigWoo.Apps.SqlCodeGen.Classes
{
    ...
    public class TableInquiryLoader
    {
        ...
        private static ITableInquiry LoadInquiry(string configurationInfoStr)
        {
            ...
            //
            // such as:
            // BigWoo.Apps.SqlCodeGen.Classes.SqlTableInquiry,SqlCodeGenSupport

            // TODO: update using BigWoo.Common.AssemblyUtility class
        ...
        public static ITableInquiry LoadInquiry(string configurationInfoStr, bool loadDefaultOnFailure)
        {
            ...
            catch
            {
                ...
                {
                    const string DEFAULT_CONFIG_INFO = "BigWoo.Apps.SqlCodeGen.Classes.SqlTableInquiry,SqlCodeGenSupport";
