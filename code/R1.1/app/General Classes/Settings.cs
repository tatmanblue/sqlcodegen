...
namespace BigWoo.Apps.SqlCodeGen.Properties
{
    ...
    public class TemplateElement : ConfigurationElement
    {
        ...
        /// <summary>
        /// This method evaluates the text to see if it matches 
        /// one or more of the values in CRUDOptions.  
        /// 
        /// TODO: use the DescriptionAttribute from the enum and/or
        /// test against the Enumeration itsself 
        /// </summary>
